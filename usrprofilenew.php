<?php include "db.php"; ?>
    ...
    <div class="container" style="width: 50%;">
        ...
        <img src="images/demo/gallery<?php echo $image;?>" width="200" style="margin-left: 32%;" class="img-circle" alt="Profile"> 
        <br><br><br><br>
        <div class="tab">
            <button class="tablinks" style="width: 33%" onclick="openCity(event, 'Personel Details')">Personal Details</button>
            <button class="tablinks" style="width: 33%" onclick="openCity(event, 'Previous Consultations')">Previous Consultations</button>
            <button class="tablinks" style="width: 33%"  onclick="openCity(event, 'Previous Prescriptions')">Previous prescriptions</button>
        </div>
